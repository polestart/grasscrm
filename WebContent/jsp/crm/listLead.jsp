	  ...
	  <div id="feature">
		<div id="shortcuts" class="headerList">
			...
			<s:if test="#request.user.create_lead == 1">
		     ...
		     <span style="white-space:nowrap;">
		       <a href="javascript:void(0)" id="mtmt" class="easyui-menubutton" data-options="menu:'#mtm1',iconCls:'icon-more'"><s:text name='menu.toolbar.more.title'/></a>
				  ...
				  <s:if test="#request.user.create_lead == 1 || #request.user.update_lead == 1">
					<div data-options="iconCls:'icon-import'" onClick="openwindow('/crm/uploadLead.jsp','<s:text name="title.import.lead" />')"><s:text name='menu.item.import.title'/></div>
				  </s:if>	  
				  <s:if test="#request.user.view_lead == 1">
					<div data-options="iconCls:'icon-export'" id="export"><s:text name='menu.item.export.title'/></div>
				  </s:if>	
				  <s:if test="#request.user.update_lead == 1">
		  ...
		  <div id="feature-content">
	        ...
	        <div id="filter" style="margin-left:30%;display:none"><s:text name="title.listLead" /></div>
		  </div>
		</div>
