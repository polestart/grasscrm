		...
		<div id="shortcuts" class="headerList">
		  ...
		  <span>
			<s:if test="#session.loginUser.create_target == 1">
			  ...
			  <s:if test="#session.loginUser.delete_target == 1">	
		      <span style="white-space:nowrap;">
		     ...
		     <span style="white-space:nowrap;">
		       <a href="javascript:void(0)" id="mtmt" class="easyui-menubutton" data-options="menu:'#mtm1',iconCls:'icon-more'"><s:text name='menu.toolbar.more.title'/></a>
				  ...
				  <s:if test="#session.loginUser.create_target == 1 || #session.loginUser.update_target == 1">
		  ...
		  <div id="feature-content">
	        ...
	        <div id="filter" style="margin-left:30%;display:none"><s:text name="title.listTarget" /></div>
		  </div>
		</div>
