  ...
  <script type="text/javascript">
    $(document).ready(function(){
	  $("#delete").click(function() {	
		  many_deleterow("deleteTarget.action?seleteIDs=");
	  });	
	  ...
	  var mygrid = jQuery("#grid").jqGrid({
			...
			height: "auto",
		   	colNames:['<s:text name="entity.id.label" />','<s:text name="entity.name.label" />',
		  		   	'<s:text name="target.title.label" />','<s:text name="entity.account.label" />',
		  		   	'<s:text name="target.office_phone.label" />','<s:text name="target.email.label" />',
