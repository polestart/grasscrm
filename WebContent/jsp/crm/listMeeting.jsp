		...
		<div id="shortcuts" class="headerList">
		  ...
		  <span>
			<s:if test="#session.loginUser.create_meeting == 1">
			  ...
			  <s:if test="#session.loginUser.delete_meeting == 1">	
		      <span style="white-space:nowrap;">
		     ...
		     <span style="white-space:nowrap;">
		       <a href="javascript:void(0)" id="mtmt" class="easyui-menubutton" data-options="menu:'#mtm1',iconCls:'icon-more'"><s:text name='menu.toolbar.more.title'/></a>
				  ...
				  <s:if test="#session.loginUser.create_meeting == 1 || #session.loginUser.update_meeting == 1">
					<div data-options="iconCls:'icon-import'" onClick="openwindow('/crm/upload.jsp?entityName=Meeting&namespace=crm&title=' + '<s:text name="title.import.meeting" />')">
