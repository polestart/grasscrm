...
<body>
  <div id="feature">
	<div id="feature-title">
	  <h2> <s:text name="title.import.success" /> </h2>	  
	  <s:actionerror />
	  <s:fielderror />
    </div>
    ...
    <div id="feature-content">		
      <s:form id="importObjectForm">
        <table style="width:100%;" border="0">
          <tr>
            <td style="text-align:center;">
              <s:text name="info.import.success">   
                <s:param><s:property value="successfulNum" /></s:param>
                <s:param><s:property value="totalNum" /></s:param>    
              </s:text> 
            </td>
          </tr>
        </table>
        <table style="width:100%;" border="0">  
          <tr>
            <td>
              <s:if test="failedNum> 0">
                <s:text name="info.import.failed">   
                  <s:param><s:property value="failedNum" /></s:param>
                  <s:param><s:property value="totalNum" /></s:param>    
                </s:text> 
                <br>
                <table border="1">
