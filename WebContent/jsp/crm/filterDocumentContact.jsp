...
<body>
  <div id="feature">
    <div id="shortcuts" class="headerList">
      ...
      <span style="white-space:nowrap;">
        <a id="select" href="#" class="easyui-linkbutton" iconCls="icon-search" plain="true" onClick="openwindow2('/crm/selectContactPage.action?relationKey=Document&relationValue=<s:property value="id" />',750,500)"><s:text name="action.select" /></a>  
      </span>	      		     		     
    </div> 		 
