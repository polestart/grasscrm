  ...
  <div id="feature">
    <div id="shortcuts" class="headerList">
      <span style="white-space:nowrap;">
        <a href="editLead.action?<s:property value="createKey" />=<s:property value="id" />" class="easyui-linkbutton" iconCls="icon-add" plain="true" target='mainFrame'><s:text name="action.createLead" /></a>  
      </span>
      <span style="white-space:nowrap;">
