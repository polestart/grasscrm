...
<script type="text/javascript">
    $(document).ready(function(){
	  $("#delete").click(function() {	
		  many_deleterow("deleteOpportunity.action?seleteIDs=");
	  });	
	  ...
	  var mygrid = jQuery("#grid").jqGrid({
			...
			height: "auto",
		   	colNames:['<s:text name="entity.id.label" />','<s:text name="entity.name.label" />',
		  		   	'<s:text name="entity.account.label" />','<s:text name="opportunity.salesStage.label" />',
	...
	<div id="page-wrap">
	  ...
	  <div id="feature">
		<div id="shortcuts" class="headerList">
		  ...
		  <span>
			<s:if test="#request.user.create_opportunity == 1">
		      <span style="white-space:nowrap;">
		        <a href="editOpportunity.action" class="easyui-linkbutton" iconCls="icon-add" plain="true"><s:text name="action.createOpportunity" /></a>  
		      </span>
			  </s:if>
			  <s:if test="#request.user.delete_opportunity == 1">	
		      <span style="white-space:nowrap;">
		        <a id="delete" href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true"><s:text name="action.deleteOpportunity" /></a>  
		      </span>
			</s:if>
		     <span style="white-space:nowrap;">
		       <a href="javascript:void(0)" id="mtmt" class="easyui-menubutton" data-options="menu:'#mtm1',iconCls:'icon-more'"><s:text name='menu.toolbar.more.title'/></a>
				  ...
				  <s:if test="#request.user.create_opportunity == 1 || #request.user.update_opportunity == 1">
					<div data-options="iconCls:'icon-import'" onClick="openwindow('/crm/uploadOpportunity.jsp','<s:text name="title.import.opportunity" />')"><s:text name='menu.item.import.title'/></div>
				  </s:if>	  
				  ...
				  <s:if test="#request.user.update_opportunity == 1">
		 ...
		 <div id="feature-content">
	        ...
	        <div id="filter" style="margin-left:30%;display:none"><s:text name="title.listOpportunity" /></div>
		  </div>
		</div>
