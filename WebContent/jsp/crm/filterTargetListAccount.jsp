...
<script type="text/javascript">	  
    $(document).ready(function(){
  	  $("#remove").click(function() {
   		  many_removerow('unselectAccount.action?relationKey=TargetList&relationValue=<s:property value="id" />&seleteIDs=');
   	  });
     ...
     $('#tt').datagrid({
		...
		height:350,
		idField:'id', 
		url:'filterTargetListAccount.action?id=<s:property value="id" />',
		columns:[[
  ...
  <div id="feature">
    <div id="shortcuts" class="headerList">
      <span style="white-space:nowrap;">
        <a href="editAccount.action?relationKey=TargetList&relationValue=<s:property value="id" />" class="easyui-linkbutton" iconCls="icon-add" plain="true" target='_blank'><s:text name="action.createAccount" /></a>  
      </span>
      <span style="white-space:nowrap;">
