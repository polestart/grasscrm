...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listDocumentStatus.action',
			saveUrl : 'saveDocumentStatus.action',
			updateUrl : 'saveDocumentStatus.action',
			destroyUrl : 'deleteDocumentStatus.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteDocumentStatus.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.documentStatus" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.documentStatus'/>"
					...
					<thead>
						<tr>
							...
							<th field="documentStatus.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="documentStatus.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="documentStatus.sequence" width="50"
