...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listSalutation.action',
			saveUrl : 'saveSalutation.action',
			updateUrl : 'saveSalutation.action',
			destroyUrl : 'deleteSalutation.action'
		});
	    $("#delete").click(function() {	
	    	many_deleterow_easyui("deleteSalutation.action?seleteIDs=");
		});		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.salutation" />
				</h2>
			</div>
			<div id="feature-content">
				...
				<table id="tt" title="<s:text name='title.grid.salutation'/>"
					...
					<thead>
						<tr>
							...
							<th field="salutation.id" width="10" ><s:text name='entity.id.label'/></th>
							<th field="salutation.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text name='entity.name.label'/></th>
							<th field="salutation.sequence" width="50"
