...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listAccountType.action',
			saveUrl : 'saveAccountType.action',
			updateUrl : 'saveAccountType.action',
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.accountType" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.accountType'/>"
