...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listTargetListType.action',
			saveUrl : 'saveTargetListType.action',
			updateUrl : 'saveTargetListType.action',
			destroyUrl : 'deleteTargetListType.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteTargetListType.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.targetListType" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.targetListType'/>"
					...
					<thead>
						<tr>
							...
							<th field="targetListType.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="targetListType.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="targetListType.sequence" width="50"
