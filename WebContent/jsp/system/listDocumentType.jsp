...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listDocumentType.action',
			saveUrl : 'saveDocumentType.action',
			updateUrl : 'saveDocumentType.action',
			destroyUrl : 'deleteDocumentType.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteDocumentType.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.documentType" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.documentType'/>"
					...
					<thead>
						<tr>
							...
							<th field="documentType.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="documentType.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="documentType.sequence" width="50"
