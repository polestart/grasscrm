...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listReminderOption.action',
			saveUrl : 'saveReminderOption.action',
			updateUrl : 'saveReminderOption.action',
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.reminderOption" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.reminderOption'/>"
					...
					<thead>
						<tr>
							...
							<th field="reminderOption.sequence" width="50"
