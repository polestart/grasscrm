...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listCampaignType.action',
			saveUrl : 'saveCampaignType.action',
			updateUrl : 'saveCampaignType.action',
			destroyUrl : 'deleteCampaignType.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteCampaignType.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.campaignType" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.campaignType'/>"
					...
					<thead>
						<tr>
							...
							<th field="campaignType.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="campaignType.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="campaignType.sequence" width="50"
