...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listCasePriority.action',
			saveUrl : 'saveCasePriority.action',
			updateUrl : 'saveCasePriority.action',
			destroyUrl : 'deleteCasePriority.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteCasePriority.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.casePriority" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.casePriority'/>"
					...
					<thead>
						<tr>
							...
							<th field="casePriority.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="casePriority.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="casePriority.sequence" width="50"
