...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listTaskPriority.action',
			saveUrl : 'saveTaskPriority.action',
			updateUrl : 'saveTaskPriority.action',
			destroyUrl : 'deleteTaskPriority.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteTaskPriority.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.taskPriority" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.taskPriority'/>"
					...
					<thead>
						<tr>
							...
							<th field="taskPriority.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="taskPriority.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="taskPriority.sequence" width="50"
