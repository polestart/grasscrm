...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listDocumentSubCategory.action',
			saveUrl : 'saveDocumentSubCategory.action',
			updateUrl : 'saveDocumentSubCategory.action',
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.documentSubCategory" />
				</h2>
			</div>
			<div id="feature-content">
				...
				<table id="tt"
					title="<s:text name='title.grid.documentSubCategory'/>"
					...
					<thead>
						<tr>
							...
							<th field="documentSubCategory.sequence" width="50"
