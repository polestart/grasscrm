...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listIndustry.action',
			saveUrl : 'saveIndustry.action',
			updateUrl : 'saveIndustry.action',
			destroyUrl : 'deleteIndustry.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteIndustry.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.industry" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.industry'/>"
					...
					<thead>
						<tr>
							...
							<th field="industry.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="industry.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="industry.sequence" width="50"
