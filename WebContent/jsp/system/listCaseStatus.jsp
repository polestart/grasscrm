...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listCaseStatus.action',
			saveUrl : 'saveCaseStatus.action',
			updateUrl : 'saveCaseStatus.action',
			destroyUrl : 'deleteCaseStatus.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteCaseStatus.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.caseStatus" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.caseStatus'/>"
					...
					<thead>
						<tr>
							...
							<th field="caseStatus.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="caseStatus.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="caseStatus.sequence" width="50"
