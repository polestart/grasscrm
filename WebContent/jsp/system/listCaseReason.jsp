...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listCaseReason.action',
			saveUrl : 'saveCaseReason.action',
			updateUrl : 'saveCaseReason.action',
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.caseReason" />
				</h2>
			</div>
			<div id="feature-content">
				...
				<table id="tt" title="<s:text name='title.grid.caseReason'/>"
					...
					<thead>
						<tr>
							...
							<th field="caseReason.sequence" width="50"
