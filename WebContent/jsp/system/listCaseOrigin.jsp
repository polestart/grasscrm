...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listCaseOrigin.action',
			saveUrl : 'saveCaseOrigin.action',
			updateUrl : 'saveCaseOrigin.action',
			destroyUrl : 'deleteCaseOrigin.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteCaseOrigin.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.caseOrigin" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.caseOrigin'/>"
					...
					<thead>
						<tr>
							...
							<th field="caseOrigin.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="caseOrigin.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="caseOrigin.sequence" width="50"
