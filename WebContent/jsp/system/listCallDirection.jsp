...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listCallDirection.action',
			saveUrl : 'saveCallDirection.action',
			updateUrl : 'saveCallDirection.action',
			destroyUrl : 'deleteCallDirection.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteCallDirection.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.callDirection" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.callDirection'/>"
					...
					<thead>
						<tr>
							...
							<th field="callDirection.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="callDirection.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="callDirection.sequence" width="50"
