...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listMeetingStatus.action',
			saveUrl : 'saveMeetingStatus.action',
			updateUrl : 'saveMeetingStatus.action',
			destroyUrl : 'deleteMeetingStatus.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteMeetingStatus.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.meetingStatus" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.meetingStatus'/>"
					...
					<thead>
						<tr>
							...
							<th field="meetingStatus.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="meetingStatus.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="meetingStatus.sequence" width="50"
