...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listPermission.action',
			saveUrl : 'savePermission.action',
			updateUrl : 'savePermission.action',
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.permission" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.permission'/>"
					style="width: 1200px; height: 380px" toolbar="#toolbar"
					...
					<thead>
						<tr>
							...
							<th field="permission.url" width="100"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='permission.url.label' /></th>									
							<th field="permission.sequence" width="10"
