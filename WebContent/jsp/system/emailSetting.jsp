				...
				<s:form id="addObjectForm" validate="true" namespace="/jsp/crm"
					...
					<table style="padding: 10px;" cellspacing="10" cellpadding="0"
						...
						<tr>
							...
							<td class="td-value"><input name="emailSetting.from_name"
							...
							<td class="td-value"><input name="emailSetting.from_address"
								class="easyui-validatebox record-value"
								data-options="required:true"
						...
						<tr>
							...
							<td class="td-value">
							  <input id="email_provider" class="easyui-combobox" name="emailSetting.email_provider" 
								style="width: 80px;"
					...
					<div id="tt" class="easyui-tabs">
						<div id="gmail" title="<s:text name='tab.gmail'/>" style="padding: 10px;">
							<table style="" cellspacing="10" cellpadding="0" width="100%">
								<tr>
									<td class="td-label"><label class="record-label"><s:text
												name="emailSetting.gmail_address.label"></s:text>：</label></td>
									<td class="td-value"><s:textfield name="emailSetting.gmail_address"
											cssClass="record-value" /></td>
									<td class="td-label"><label class="record-label"><s:text
												name="emailSetting.gmail_password.label"></s:text>：</label></td>
									<td class="td-value">
									  <input type="password" name="emailSetting.gmail_password" class="record-value" value="<s:property value="emailSetting.gmail_password" />"/>
									</td>
								</tr>
							</table>
						</div>

						<div id="yahoo" title="<s:text name='tab.yahoo'/>" style="padding: 10px;">
							<table style="" cellspacing="10" cellpadding="0" width="100%">
								<tr>
									<td class="td-label"><label class="record-label"><s:text
												name="emailSetting.yahoo_mail_ID.label"></s:text>：</label></td>
									<td class="td-value"><s:textfield name="emailSetting.yahoo_mail_ID"
											cssClass="record-value" /></td>
									<td class="td-label"><label class="record-label"><s:text
												name="emailSetting.yahoo_mail_password.label"></s:text>：</label></td>
									<td class="td-value">
									  <input type="password" name="emailSetting.yahoo_mail_password" class="record-value" value="<s:property value="emailSetting.yahoo_mail_password" />"/>
									</td>
								</tr>
							</table>
						</div>
						
						<div id="other" title="<s:text name='tab.other'/>" style="padding: 10px;">
							<table style="" cellspacing="10" cellpadding="0" width="100%">
								<tr>
									<td class="td-label"><label class="record-label"><s:text
												name="emailSetting.smtp_server.label"></s:text>：</label></td>
									<td class="td-value"><s:textfield name="emailSetting.smtp_server"
											cssClass="record-value" /></td>
									<td class="td-label"><label class="record-label"><s:text
												name="emailSetting.smtp_port.label"></s:text>：</label></td>
									<td class="td-value"><input name="emailSetting.smtp_port"
								...
								<tr>
									...
									<td class="td-value"><s:checkbox id="emailSetting.smtp_authentication"
											name="emailSetting.smtp_authentication" cssClass="record-value" /></td>
									<td class="td-label"><label class="record-label"><s:text
												name="emailSetting.smtp_protocol.label"></s:text>：</label></td>
									<td class="td-value">
									  <input id="smtp_protocol" class="easyui-combobox" name="emailSetting.smtp_protocol" 
										style="width: 80px;"
										data-options="valueField:'value',textField:'label',
										data: [{
								...
								<tr>
									...
									<td class="td-value"><s:textfield name="emailSetting.smtp_username"
											cssClass="record-value" /></td>
									<td class="td-label"><label class="record-label"><s:text
												name="emailSetting.smtp_password.label"></s:text>：</label></td>
									<td class="td-value">
									  <input type="password" name="emailSetting.smtp_password" class="record-value" value="<s:property value="emailSetting.smtp_password" />"/>
									</td>
								</tr>															
							</table>
						</div>						
