...
<script type="text/javascript">
	$(function() {
		$('#tt').edatagrid({
			url : 'listLeadStatus.action',
			saveUrl : 'saveLeadStatus.action',
			updateUrl : 'saveLeadStatus.action',
			destroyUrl : 'deleteLeadStatus.action'
		});
	    $("#delete").click(function() {	
			  many_deleterow("deleteLeadStatus.action?seleteIDs=");
		    });		
	});
</script>
</head>
	...
	<div id="page-wrap">
		...
		<div id="feature">
			<div id="feature-title">
				<h2>
					<s:text name="title.grid.leadStatus" />
				</h2>
			</div>
			<div id="feature-content">
				<table id="tt" title="<s:text name='title.grid.leadStatus'/>"
					...
					<thead>
						<tr>
							...
							<th field="leadStatus.id" width="50" hidden="true"><s:text
									name='entity.id.label' /></th>
							<th field="leadStatus.name" width="50"
								editor="{type:'validatebox',options:{required:true}}"><s:text
									name='entity.name.label' /></th>
							<th field="leadStatus.sequence" width="50"
