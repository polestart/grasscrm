...
<%@ page language="java" import="java.util.Map" contentType="text/html; charset=UTF-8"
	...
	<div id="mm1" style="width:150px;">
		...
		<s:if test="#request.user.view_account == 1"><div onClick="openPage('/crm/listAccountPage.action')"><s:text name='menu.accounts.title'/></div></s:if>
		<s:if test="#request.user.view_contact == 1"><div onClick="openPage('/crm/listContactPage.action')"><s:text name='menu.contacts.title'/></div></s:if>
		<s:if test="#request.user.view_opportunity == 1"><div onClick="openPage('/crm/listOpportunityPage.action')"><s:text name='menu.opportunities.title'/></div></s:if>
		<s:if test="#request.user.view_lead == 1"><div onClick="openPage('/crm/listLeadPage.action')"><s:text name='menu.leads.title'/></div></s:if>
		<s:if test="#request.user.view_targetList == 1"><div onClick="openPage('/crm/listTargetListPage.action')"><s:text name='menu.targetLists.title'/></div></s:if>
	</div>
	<div id="mm2" style="width:100px;">
		<s:if test="#request.user.view_account == 1"><div onClick="openPage('/crm/listAccountPage.action')"><s:text name='menu.accounts.title'/></div></s:if>	
		<s:if test="#request.user.view_contact == 1"><div onClick="openPage('/crm/listContactPage.action')"><s:text name='menu.contacts.title'/></div></s:if>
		<s:if test="#request.user.view_campaign == 1"><div onClick="openPage('/crm/listCampaignPage.action')"><s:text name='menu.campaigns.title'/></div></s:if>
		<s:if test="#request.user.view_target == 1"><div onClick="openPage('/crm/listTargetPage.action')"><s:text name='menu.targets.title'/></div></s:if>
		<s:if test="#request.user.view_targetList == 1"><div onClick="openPage('/crm/listTargetListPage.action')"><s:text name='menu.targetLists.title'/></div></s:if>
	</div>
	<div id="mm3" style="width:100px;">
		<s:if test="#request.user.view_contact == 1"><div onClick="openPage('/crm/listContactPage.action')"><s:text name='menu.contacts.title'/></div></s:if>
		<s:if test="#request.user.view_case == 1"><div onClick="openPage('/crm/listCasePage.action')"><s:text name='menu.cases.title'/></div></s:if>
		<s:if test="#request.user.view_targetList == 1"><div onClick="openPage('/crm/listTargetListPage.action')"><s:text name='menu.targetLists.title'/></div></s:if>
	</div>
	<div id="mm4" style="width:100px;">
		<s:if test="#request.user.view_call == 1"><div onClick="openPage('/crm/listCallPage.action')"><s:text name='menu.calls.title'/></div></s:if>	
		<s:if test="#request.user.view_meeting == 1"><div onClick="openPage('/crm/listMeetingPage.action')"><s:text name='menu.meetings.title'/></div></s:if>
		<s:if test="#request.user.view_task == 1"><div onClick="openPage('/crm/listTaskPage.action')"><s:text name='menu.tasks.title'/></div></s:if>
		<s:if test="#request.user.view_targetList == 1"><div onClick="openPage('/crm/listTargetListPage.action')"><s:text name='menu.targetLists.title'/></div></s:if>
	</div>
	<div id="mm5" style="width:100px;">
		<s:if test="#request.user.view_document == 1"><div onClick="openPage('/crm/listDocumentPage.action')"><s:text name='menu.documents.title'/></div></s:if>
		<s:if test="#request.user.view_targetList == 1"><div onClick="openPage('/crm/listTargetListPage.action')"><s:text name='menu.targetLists.title'/></div></s:if>
	</div>
